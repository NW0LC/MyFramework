...
public class ProgressWheel extends View {
    ...
    /**
     * @return the cn.com.exz.beefrog.base spinning speed, in full circle turns per second
    ...
    /**
     * Sets the cn.com.exz.beefrog.base spinning speed, in full circle turns per second
     * (1.0 equals on full turn in one second), this value also is applied for
     * the smoothness when setting a progress
     *
     * @param spinSpeed the desired cn.com.exz.beefrog.base speed in full turns per second
     */
