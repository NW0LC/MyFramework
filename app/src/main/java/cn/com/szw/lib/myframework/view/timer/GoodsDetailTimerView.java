package cn.com.szw.lib.myframework.view.timer;
...
public class GoodsDetailTimerView extends LinearLayout {
    ...
    public GoodsDetailTimerView(Context context, AttributeSet attr) {
        super(context, attr);
        init(context);
    }
...
//                    getNumTv().setPadding(SizeUtils.dp2px(3),SizeUtils.dp2px(2),SizeUtils.dp2px(3),SizeUtils.dp2px(2));
                    ...
                    break;
                case HOUR_TAG:
                    getUnitTv().setText("小时");
//                    getNumTv().setBackground(ContextCompat.getDrawable(context,R.drawable.time_black_line));
//                    getNumTv().setPadding(SizeUtils.dp2px(3),SizeUtils.dp2px(2),SizeUtils.dp2px(3),SizeUtils.dp2px(2));
                    getNumTv().setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
                    break;
                case MIN_TAG:
                    getUnitTv().setText("分钟");
//                    getNumTv().setBackground(ContextCompat.getDrawable(context,R.drawable.time_black_line));
//                    getNumTv().setPadding(SizeUtils.dp2px(3),SizeUtils.dp2px(2),SizeUtils.dp2px(3),SizeUtils.dp2px(2));
                    getNumTv().setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
                    break;
...
//                    getNumTv().setTextColor(ContextCompat.getColor(context,R.color.red_de1a19));
        ...
        private TextView getNumTv() {
            if (numTv == null) {
                ...
                numTv.setTextColor(ContextCompat.getColor(context, R.color.orange));
        ...
        private TextView getUnitTv() {
            if (unitTv == null) {
                ...
                unitTv.setTextColor(ContextCompat.getColor(context,R.color.orange));
